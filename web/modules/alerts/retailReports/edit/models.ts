...
export const posPropertiesFormFields = {
  cash: new FormFieldModel(0),
  credit_debit: new FormFieldModel(0),
  other: new FormFieldModel(0),
  total: new FormFieldModel(0)
};

const PosPropertiesFormModel = FormModel.Factory(posPropertiesFormFields);

export const salesPosFormFields = {
  changes_abs: new PosPropertiesFormModel(),
  changes_rel: new PosPropertiesFormModel(),
  values: new PosPropertiesFormModel(),
  values_submitted: new PosPropertiesFormModel()
};

const SalesPosFormModel = FormModel.Factory(salesPosFormFields);
...
const retailFormFields = {
  ...
  fetched_bank: new FormFieldModel(false),
  fetched_metrc: new FormFieldModel(false),
  fetched_pos: new FormFieldModel(false),
  ...
  quarterly: new FormFieldModel(false),
  ready: new FormFieldModel(false),
  sales_current_month: new SalesFormModel(),
  sales_metrc_comparison: new SalesMetrcFormModel(),
  sales_pos_comparison: new SalesPosFormModel(),
...
export const RetailFormModel = FormModel.Factory(retailFormFields);
