...
export const RejectDocumentFileDialog = React.memo((properties: Properties & RouterComponentProps) => {
  ...
  return (
    <ApproveRejectFileForm kind="reject" value={value} onChange={onChange} onSubmit={onSubmit} onCancel={onCancel} />
  );
});
