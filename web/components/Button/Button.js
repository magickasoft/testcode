import { Iconed, IconedPropTypes } from 'components/Icon';
...
const FACES = [FACE_DEFAULT, FACE_PRIMARY, FACE_SECONDARY, FACE_DANGER, FACE_LINK];
...
export class Button extends PureComponent {
  ...
  render() {
    const { disabled, face, rounded, size, ...props } = this.props;
      ...
      <Sized size={size}>
        ...
        >
          <button
            ...
            disabled={disabled}
            className={bem.block(this, { disabled, rounded, [face]: !!face })}
          />
        </Iconed>
      </Sized>
    );
